...
foundation_ids = [
    {"_id": str(ObjectId()), "foundation_id": "VGULG-001", "member_name": "Admin User"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-002", "member_name": "Recruiter One"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-003", "member_name": "Member One"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-004", "member_name": "Member Two"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-005", "member_name": "Volunteer One"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-006", "member_name": "Recruiter Two"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-007", "member_name": "Reserved Slot 7"},
    {"_id": str(ObjectId()), "foundation_id": "VGULG-008", "member_name": "Reserved Slot 8"},
]
